...
class CellExcel implements ICell {
    ...
    // we use this function to display the cells that we already know are
    // different. For formulae we display the cached value as that is useful
    // we it comes from a linked sheet that we can not see
	@Override
	public String getDisplayValue() {
		int cellType = cell.getCellType();
		switch (cellType) {
		case Cell.CELL_TYPE_FORMULA:
		    return String.format("%s = %s", String.valueOf(cell.getNumericCellValue()), getStringValue());
		}
